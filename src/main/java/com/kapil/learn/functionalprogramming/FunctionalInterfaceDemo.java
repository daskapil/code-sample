package com.kapil.learn.functionalprogramming;
...
public class FunctionalInterfaceDemo {
    public static void main(String[] args) {
        ...
        List<String> docs = new ArrayList<>(Arrays.asList(doc1, doc2, doc3, doc4));
...
//                doc = transform(doc, d -> Indexer.removeStopWords(d));
                ...
                Function<String, String> htmlClear = d -> Indexer.stripHtmlTags(d);
//                doc = transform(doc, htmlClear);
...
//                stopWordRemover.apply(doc);
                Function<String, String> docProcessor = htmlClear.andThen(stopWordRemover);
